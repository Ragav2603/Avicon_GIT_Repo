...
class TestDraftsEndpoints:
    ...
    def test_draft_presence_requires_auth(self):
        ...
        response = requests.post(
            f"{BASE_URL}/api/drafts/some-draft-id/presence", json=payload
        )
        assert response.status_code == 401, f"Expected 401, got {response.status_code}"
...
class TestIntegrationsEndpoints:
    ...
    def test_connect_sharepoint_requires_auth(self):
        ...
        response = requests.post(
            f"{BASE_URL}/api/integrations/sharepoint/connect", json=payload
        )
        assert response.status_code == 401, f"Expected 401, got {response.status_code}"
    ...
    def test_connect_onedrive_requires_auth(self):
        ...
        response = requests.post(
            f"{BASE_URL}/api/integrations/onedrive/connect", json=payload
        )
        assert response.status_code == 401, f"Expected 401, got {response.status_code}"
    ...
    def test_connect_gdocs_requires_auth(self):
        ...
        response = requests.post(
            f"{BASE_URL}/api/integrations/gdocs/connect", json=payload
        )
        assert response.status_code == 401, f"Expected 401, got {response.status_code}"
    ...
    def test_disconnect_sharepoint_requires_auth(self):
        ...
        assert response.status_code == 401, f"Expected 401, got {response.status_code}"
        print(
            "✅ DELETE /api/integrations/sharepoint/disconnect returns 401 without auth"
        )
    ...
    def test_sync_file_requires_auth(self):
        response = requests.post(
            f"{BASE_URL}/api/integrations/sharepoint/sync/file-123"
        )
        assert response.status_code == 401, f"Expected 401, got {response.status_code}"
        print(
            "✅ POST /api/integrations/sharepoint/sync/{file_id} returns 401 without auth"
        )
...
class TestInvalidProviders:
    ...
    def test_invalid_provider_connect(self):
        ...
        response = requests.post(
            f"{BASE_URL}/api/integrations/dropbox/connect", json=payload
        )
