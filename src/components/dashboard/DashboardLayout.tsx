...
const DashboardLayout = ({ children, title, subtitle }: DashboardLayoutProps) => {
  ...
  const notifications = [
    { id: 1, text: "New proposal from TechCorp", time: "5 min ago" },
    { id: 2, text: "AI Verification complete for RFP #12", time: "1 hour ago" },
    { id: 3, text: "Deadline reminder: Cloud Migration RFP", time: "2 hours ago" },
  ];
          ...
          <div className="flex items-center gap-4">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-80">
                ...
                <DropdownMenuSeparator />
                <DropdownMenuItem className="justify-center text-secondary">
