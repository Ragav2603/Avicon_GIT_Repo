...
interface VendorControlTowerLayoutProps {
...
const navItems = [
  ...
  { id: "settings", label: "Settings", icon: Settings, path: "/vendor-dashboard/settings" },
];
...
const VendorControlTowerLayout = ({ children, title, subtitle, actions }: VendorControlTowerLayoutProps) => {
  ...
  const notifications = [
    { id: 1, text: "New opportunity: Cloud Migration for Delta", time: "10 min ago" },
    { id: 2, text: "Your proposal was shortlisted!", time: "2 hours ago" },
    { id: 3, text: "Deadline reminder: United Airlines Project", time: "5 hours ago" },
  ];
          ...
          {!sidebarCollapsed ? (
            <div className="flex items-center gap-3 p-2 rounded-lg bg-sidebar-accent/50">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-sidebar-foreground/60">Vendor</p>
              </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-56">
                <DropdownMenuItem onClick={() => navigate("/vendor-dashboard/settings")}>
...
export default VendorControlTowerLayout;
